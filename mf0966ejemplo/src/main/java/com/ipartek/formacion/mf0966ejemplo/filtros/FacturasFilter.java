...
@WebFilter("/facturas")
public class FacturasFilter extends HttpFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (usuario != null) {
			...
			req.setAttribute("alertaMensaje", "Necesito que te loguees para poder acceder a las facturas");
